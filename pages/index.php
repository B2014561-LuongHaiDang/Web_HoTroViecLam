  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div><a href="login.php"><button type="button" class="btn btn-white text-dark">| Người tìm việc</button></a></div>
        <div><a href="http://localhost/web_mysqli/pages/nhatuyendung/login.php"><button type="button" class="btn btn-white text-dark">| Nhà tuyển dụng</button></a></div>
      </div>
    </div>
  </nav>
