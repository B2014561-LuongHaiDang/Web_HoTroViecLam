...
<body>
  ...
  <img style="width: 100%;" src="<?= $cty['anhdaidien'] ?>" alt="">  
    ...
    <div class="text-center py-2"><a class=" text-decoration-none text-dark h3"><?= $cty['tencongty'] ?></a></div>
    <div class="text-center">
      <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 2 21 16">
  ...
  <div class="container">
    <div class="row ">
      ...
      <p class="ms-2"><?= $cty['thongtincongty'] ?></p>
        <div class="row">
        <div class="col-sm-6 col-md-6">
          ...
          <div class="d-flex flex-row-reverse col-sm-6 col-md-6">
            <div class=" text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="currentColor" class="bi bi-bell" viewBox="0 3 21 16">
      ...
      <div class="col-6 col-md-4 py-2 g-3" style="background-color: #f8f9fa;">
        ...
        <div class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
          ...
          <a class=" text-decoration-none h6 text-primary" href="https://thanhconghome.com/"><?= $cty['link'] ?></a>
        </div>
