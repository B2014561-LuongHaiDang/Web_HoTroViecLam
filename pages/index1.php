        ...
        <div class="container-fluid container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="ps-2 fw-bold"><?php
                        ...
                        ?></div>
                <div><a href="#"><button type="button" class="btn btn-white text-dark">| Nhà tuyển dụng</button></a></div>
    ...
    <div class="row">
      ...
      <div class=" col sm-4 md-4">
        <div class="row">
          ...
          <div class="col-sm-6 col-md-9 py-1">
            <div><a class="text-decoration-none text-dark h4 " href=""><?php
                        if (isset($_SESSION['dangnhap10'])) {
                            echo $_SESSION['dangnhap10'];
                        }
                        ?></a></div>
            <div class="" style="width: 350px; height: 20px; border: 1px #e0d8d8; overflow-x:hidden"><a class=" text-decoration-none text-dark h6" href=""><?php
                        if (isset($_SESSION['dangnhap11'])) {
                            echo $_SESSION['dangnhap11'];
                        }
                        ?></a></div>
            <div><a class="text-decoration-none text-dark h6 " href=""><?php
                        if (isset($_SESSION['dangnhap12'])) {
                            echo $_SESSION['dangnhap12'];
                        }
                        ?></a></div>
          </div>
        </div>
