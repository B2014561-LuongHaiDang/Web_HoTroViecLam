...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid ">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="http://localhost/web_mysqli/pages/index.php">Trang chủ</a>
                  </li>
        ...
        <img class="img-fluid"  src="images/cty1.jpg" />
        </div>
        <div class="text-center py-2"><a class=" text-decoration-none text-dark h3" style="background-color: #f8f9fa;" href="company_profile/cty1.php">CÔNG TY TNHH TẬP ĐOÀN THÀNH CÔNG HOME</a></div>
        <div class="text-center">
            <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" 
            viewBox="0 2 21 16">
            <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A31.493 31.493 0 0 1 8 14.58a31.481 31.481 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 
            ...
            <span style="width:400px">Số 231-233 Lê Thánh Tôn, Quận 1, Hồ Chí Minh</span></div>
        </div>
        </div>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-sm-6 col-md-8 border g-3 " style="background-color: #f8f9fa;">
                    <h4 class="text-primary ms-2" style="padding-top:10px">Về chúng tôi</h4>
                    <h5 class="ms-2">TC HOME là công ty dịch vụ bất động sản hàng đầu về uy tín và chất lượng dịch vụ.</h5>
                    <h5 class="ms-2">TC HOME phân phối trực tiếp (F1) các sản phẩm bất động sản đô thị và nghỉ dưỡng từ các chủ đầu tư uy tín.</h5>
                    
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                        <h4 class="text-primary py-4 ms-2">Việc đang tuyển</h4>
                        </div>
                        <div class="d-flex flex-row-reverse col-sm-6 col-md-6">
                            <div class="py-4 text-primary"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="currentColor" class="bi bi-bell" 
                            viewBox="0 3 21 16">
                    ...
                    <div class="row" style="padding-bottom: 20px;">
                        <div class="col-sm-6 col-md-6">
                        <h5 class="ms-2">1 việc làm</h5>
                        </div>
                        <div class="d-flex flex-row-reverse col-sm-6 col-md-6">
                            <div class="ms-3"> <a class="nav-link dropdown-toggle text-dark" href="#" role="button" data-bs-toggle="dropdown">Mới cập nhật</a>
                        ...
                        <div class="row" style="padding-bottom: 20px">
                            ...
                            <div class="col-sm-7 col-md-7">
                                <div class="row border" style="height:109px; background: #dee2e6;">
                                    <div class="d-flex flex-row-reverse col-sm-6 col-md-3">
                                        <img class="img-fluid hot-job__logo img-thumbnail mr-2 mr-sm-3 border-0 bg-white"
                                        style="width: 105px; height: 107px" src="images/logo_cty1.png"/>
                                    </div>
                                    <div class="col-sm-6 col-md-9 py-3">
                ...
                <div class="col-6 col-md-4 border g-3" style="height: 160px ; background-color: #f8f9fa;">
                    <h4 class="text-dark ms-2" style="padding-top:10px">Website</h4>
                    <div class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
                        ...
                        <a class=" text-decoration-none h6 text-primary"  href="https://thanhconghome.com/">https://thanhconghome.com/</a>
                    </div>
...
<hr/>
            <div class="container" style="background-color:#e0d8d8 ; padding-bottom:20px">
                <div class="row">

                    <div class="col-sm-3 col-md-3 h4">Về hỗ trợ việc làm
                        <div class="h5 ms-2"><a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover" 
                        href="#">Về chúng tôi</a>
                        </div>
                    </div>


                    <div class="col-sm-3 col-md-3 h4">Dành cho ứng viên</div>
                    <div class="col-sm-3 col-md-3 h4">Việc làm theo khu vực</div>
                    <div class="col-sm-3 col-md-3"></div>
                </div>

                <div class="row">
                    <div class="col-sm-3 col-md-3 h4">Chứng nhận</div>
                    <div class="col-sm-3 col-md-3 h4">Dành cho nhà tuyển dụng</div>
                    <div class="col-sm-3 col-md-3 h4">Việc làm theo ngành nghề</div>
                </div>
            </div>
