...
<body>
    ...
    <div class="ms-2 me-3 mt-3">
        <div class="h1 text-center">CHÀO QUẢN TRỊ VIÊN</div>
        <div class="h5 text-center text-danger">Vui lòng đăng xuất sau khi sử dụng xong !!!</div>
        <div class="h3">Bạn muốn xử lí :</div>
        <div>
            <a href="add.php"><input type="submit" name="submit" class="" value="Thông tin tuyển dụng"></a>
        </div>
        <div>
