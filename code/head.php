    ...
    <div class="container border-bottom">
      ...
      <div class="collapse navbar-collapse bg-white" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="nganhnghe.php"><i class="fa-solid fa-book text-success"></i>Ngành nghề<i class="fa-solid fa-location-dot text-success ms-1"></i>Khu vực</a>
          </li>
        ...
        <div class="d-flex align-items-center">
          ...
          ?>
          <div><a class="text-decoration-none text-dark ms-3 " href="../admincp/login.php"><i class="fa-solid fa-user-gear text-success"></i>Admin</a></div>
        </div>
      </div>
    </div>
  </nav>
